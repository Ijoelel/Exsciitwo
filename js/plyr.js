"object" == typeof navigator &&
	(function (e, t) {
						...
						(function () {
							...
							[
								...
								(i.createObjectURL = function (e) {
									return t.createObjectURL.apply(
										t,
										arguments
									);
								}),
								(i.revokeObjectURL = function (e) {
									return t.revokeObjectURL.apply(
										t,
										arguments
									);
								}),
					...
					[
						...
						},
						{
							...
							value: function (t) {
								...
								return (
									0 >
									(i = (100 / l.width) * (n.clientX - l.left))
										? (i = 0)
										: 100 < i && (i = 100),
									50 > i
										? (i -= (100 - 2 * i) * c)
		...
		const Me = {
			...
			setRange(e, t = 0) {
				A.element(e) &&
					((e.value = t), Me.updateRangeFill.call(this, e));
			},
			updateProgress(e) {
			...
			timeUpdate(e) {
				const t =
					!A.element(this.elements.display.duration) &&
			...
			setCaptionsMenu() {
				...
				const n = i.map((e, i) => ({
					...
					badge:
						e.language &&
						Me.createBadge.call(this, e.language.toUpperCase()),
					list: t,
					type: "language",
				}));
				n.unshift({
			...
			toggleMenu(e) {
				...
				if (A.boolean(e)) n = e;
					...
					const s = A.function(e.composedPath)
							? e.composedPath()[0]
							: e.target,
						a = t.contains(s);
			...
			create(e) {
				...
				return (
					...
					this.isHTML5 &&
						r.call(this, me.getQualityOptions.call(this)),
					o.call(this),
					c
				);
			},
			inject() {
				...
				A.function(this.config.controls) &&
					...
					A.element(this.config.controls) ||
						...
						e
							...
							.forEach((e) => {
								this.debug.log("Track added", e),
									...
									J.call(this, e, "cuechange", () =>
										Ne.updateCues.call(this)
									);
							}),
						((a && this.language !== i) || !e.includes(n)) &&
							(Ne.setLanguage.call(this, i),
				...
				t(this, "onChange", () => {
					...
					t(this, "toggleFallback", (e = !1) => {
						if (
							...
							const s =
								A.string(t.content) && t.content.includes(i);
							e
					...
					(this.forceFallback =
						"force" === e.config.fullscreen.fallback),
		...
		const Ue = {
			...
			setTitle() {
				...
				if (
					...
					if (!A.element(e)) return;
					const t = A.empty(this.config.title)
							? "video"
							: this.config.title,
			...
			migrateStyles() {
				Object.values({ ...this.media.style })
					.filter(
						(e) =>
							!A.empty(e) && A.string(e) && e.startsWith("--plyr")
					)
					.forEach((e) => {
					...
					t(this, "controls", () => {
						...
						this.bind(
							...
							this.bind(
								...
								(t) => Me.updateSeekTooltip.call(e, t)
							),
							this.bind(
								t.progress,
								"mousemove touchmove",
						...
						if (
							...
							if ("touchmove" === e.type)
								...
								(this.seekTime =
									...
									(this.elements.thumb.time.innerText = Pe(
										this.seekTime
									));
								const a =
